...
def test_chinese_tagging_no_duplicates():
    ...
    assert words == [
        Word(token="石室", tag="名词", lemma="石室"),
        Word(token="诗士", tag="名词", lemma="诗士"),
        Word(token="施氏", tag="人名", lemma="施氏"),
        Word(token="嗜狮", tag="名词", lemma="嗜狮"),
        Word(token="誓食", tag="动词", lemma="誓食"),
        Word(token="十", tag="数词", lemma="十"),
        Word(token="狮", tag="语素", lemma="狮"),
        Word(token="氏", tag="语素", lemma="氏"),
        Word(token="时时", tag="副词", lemma="时时"),
        Word(token="适市", tag="形容词", lemma="适市"),
        Word(token="视狮", tag="名词", lemma="视狮"),
        Word(token="时", tag="语素", lemma="时"),
        Word(token="适十", tag="动词", lemma="适十"),
        Word(token="狮适市", tag="地名", lemma="狮适市"),
        Word(token=" ", tag="语素", lemma=" "),
        Word(token="是", tag="动词", lemma="是"),
        Word(token="适施", tag="动词", lemma="适施"),
        Word(token="氏适市", tag="地名", lemma="氏适市"),
        Word(token="视", tag="语素", lemma="视"),
        Word(token="恃", tag="语素", lemma="恃"),
        Word(token="矢势", tag="名词", lemma="矢势"),
        Word(token="使", tag="动词", lemma="使"),
        Word(token="逝世", tag="动词", lemma="逝世"),
        Word(token="氏拾", tag="动词", lemma="氏拾"),
        Word(token="尸", tag="语素", lemma="尸"),
        Word(token="适石室", tag="名词", lemma="适石室"),
        Word(token="湿", tag="形容词", lemma="湿"),
        Word(token="侍拭石室", tag="名词", lemma="侍拭石室"),
        Word(token="拭", tag="语素", lemma="拭"),
        Word(token="始", tag="语素", lemma="始"),
        Word(token="试食", tag="动词", lemma="试食"),
        Word(token="食", tag="语素", lemma="食"),
        Word(token="始识", tag="名词", lemma="始识"),
        Word(token="实", tag="形容词", lemma="实"),
        Word(token="石", tag="语素", lemma="石"),
        Word(token="试释", tag="动词", lemma="试释"),
        Word(token="事", tag="名词", lemma="事"),
    ]
