...
class WebsterDefinedRunOnPhraseTest extends AnyFunSpec {
  describe("a definition") {
    ...
    val domain =
      "{\"definedRunOnPhrase\":\"abide by\",\"definition\":[{\"senseSequence\":[[{\"definingText\":{\"text\":[\"to conform to\"],\"examples\":[{\"text\":\"*abide by* the rules\"}]}}],[{\"definingText\":{\"text\":[\"to accept without objection\",\"to {d_link|acquiesce|acquiesce} in\"],\"examples\":[{\"text\":\"will *abide by* your decision\"}]}}]]}]}"
