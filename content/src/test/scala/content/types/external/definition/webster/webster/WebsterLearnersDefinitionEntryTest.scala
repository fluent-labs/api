package content.types.external.definition.webster.webster

import com.foreignlanguagereader.content.types.Language
import com.foreignlanguagereader.content.types.external.definition.webster.webster.WebsterLearnersDefinitionEntry
